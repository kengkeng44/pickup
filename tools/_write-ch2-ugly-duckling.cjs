  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch2-l2-q9',
        ...
        '但其他鴨寶寶在他背後悄悄說話。'),
      emoji('kt-ch2-l2-q10',
        'They stood in a line and kept their eyes on him without a word.',
        'How did the other ducklings act?',
        ['🙄 looking away', '👀 staring', '🤝 friendly', '🎉 happy'],
        ['移開視線', '盯著看', '友善', '開心'],
        1,
        '推理:站成一排 + 眼睛黏在他身上 + 不說話 → 盯著看。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch2-l4-q5',
        ...
        '兩隻野鴨讓他在高高的草叢旁邊休息。'),
      mc('kt-ch2-l4-q6',
        'One of them shared half his lunch and would not leave his side.',
        'What did one wild duck become to him?',
        ['a teacher', 'a friend', 'an enemy', 'a brother'],
        ['老師', '朋友', '敵人', '哥哥'],
        1,
        '推理:分一半午餐 + 不肯離開 → 已經當他是同伴 → 朋友。'),
      nar('kt-ch2-l4-q7',
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch2-l5-q5',
        ...
        '老婆婆把他留在溫暖的廚房好幾個禮拜。'),
      mc('kt-ch2-l5-q6',
        'The cat sat heavy on his back and dug into his soft feathers.',
        'How did the cat treat him?',
        ['cleaned him', 'played gently', 'pressed claws on him', 'sang for him'],
        ['幫他洗澡', '溫柔玩耍', '用爪子壓他', '對他唱歌'],
        2,
        '推理:重重坐 + 抓進羽毛裡 → 不是玩,是用爪子壓 → 用爪子壓他。'),
      nar('kt-ch2-l5-q7',
        'The hen counted her own warm eggs each morning and looked away.',
        '母雞每天早上數著自己暖暖的蛋,然後別過頭去。'),
      mc('kt-ch2-l5-q8',
        'She told him he was useless and not worth the food he ate.',
        'Why did the hen mock him?',
        ['too noisy', 'never gave any eggs', 'always running away', 'always sleeping'],
        ['他太吵', '他不會生蛋', '他一直跑', '他一直睡'],
        1,
        '推理:母雞數蛋 + 罵他沒用、不值得吃的 → 因為他不像母雞會生蛋 → 不會生蛋。'),
      nar('kt-ch2-l5-q9',
        'The cat asked him if he could purr by the warm fire.',
        '貓問他能不能在暖暖的火邊發出咕嚕聲。'),
      emoji('kt-ch2-l5-q10',
        'The wind under the door felt sharper than the cat\'s claws on his back.',
        'What is waiting outside?',
        ['❄️ cold night', '☀️ warm sun', '🌸 spring garden', '🏖️ beach'],
        ['冷夜', '暖陽', '春天花園', '海灘'],
        0,
        '推理:門縫的風比貓爪還刺 → 外面又黑又寒 → 冷夜。'),
