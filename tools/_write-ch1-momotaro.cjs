...
const lessons = [
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch1-l2-q2',
        ...
        '一個春天,老婆婆像平常一樣去河邊。'),
      nar('kt-ch1-l2-q3',
        'She saw something pink and round floating on the water.',
        '她看見一個粉紅又圓的東西漂在水上。'),
      emoji('kt-ch1-l2-q4',
        'A pink fruit larger than a basket floated toward her.',
      ...
      mc('kt-ch1-l2-q6',
        'The fruit\'s skin was the bright color of a peach.',
      ...
      gist('kt-ch1-l2-q8',
        'Pink and round, it floated and turned in the slow river.',
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      mc('kt-ch1-l4-q11',
        'His parents said goodbye with tears in their eyes.',
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      mc('kt-ch1-l6-q5',
        'One friend flew over the high wall with its wings.',
        ...
        '用翅膀飛 = 雉雞。'),
      mc('kt-ch1-l6-q6',
        'Another friend climbed the wall with quick hands.',
      ...
      mc('kt-ch1-l6-q11',
        'The demons gave up and asked Momotaro to spare their lives.',
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch1-l7-q2',
        'The demons gave Momotaro all their secret treasures.',
        '妖怪把所有藏起來的寶物都交出來。'),
      nar('kt-ch1-l7-q3',
