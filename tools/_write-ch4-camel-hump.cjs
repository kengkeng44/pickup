...
const lessons = [
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l1-q5',
        ...
        '你看,親愛的,駱駝整天什麼也不做。'),
      // Q6 listen-mc INFERENCE — rude noise → he disliked being bothered
      mc('kt-ch4-l1-q6',
        'When others asked, the Camel only made a short rude noise.',
        'How did the Camel feel about the questions?',
        ['eager to chat', 'bothered by them', 'sleepy and quiet', 'unsure what to say'],
        ['很想聊天', '覺得被打擾', '想睡又安靜', '不知道怎麼回'],
        1,
        '推理:粗魯短聲 + 別人問就打發 → 他覺得被打擾 → 答 bothered。'),
      // Q7 BEAT C — the one word he said
      nar('kt-ch4-l1-q7',
        'He only said one thing: "Humph!" and turned away.',
        '他只說一個字:「Humph!」然後就轉開。'),
      // Q8 listen-mc INFERENCE — lazy push-off → he felt others wasted his time
      mc('kt-ch4-l1-q8',
        'It was his lazy way to push the others off.',
        'Why did the Camel use that word?',
        ['greeting a kind friend', 'keeping his peace alone', 'sharing an old song', 'thanking Man for food'],
        ['打招呼問候朋友', '想自己一個人安靜', '分享老歌', '感謝人類給食物'],
        1,
        '推理:懶 + 推開別人 → 他想自己安靜不被打擾 → 答 keep peace alone。'),
      // Q9 BEAT D — transition (animals begin to feel something)
      nar('kt-ch4-l1-q9',
        'The other animals all worked hard from sun-up to sun-down.',
        '其他動物從日出工作到日落。'),
      // Q10 emoji-pick INFERENCE — feeling, not literal place
      emoji('kt-ch4-l1-q10',
        'The other animals slowly stopped coming to see him.',
        'How might the Camel feel each evening?',
        ['😶 quiet and apart', '🥳 happy and busy', '😡 angry at his friends', '😴 ready for a long sleep'],
        ['安靜又疏離', '開心又忙碌', '生朋友的氣', '準備長眠'],
        0,
        '推理:大家漸漸不來 + 他總說 humph → 他變孤單疏離 → 答 quiet and apart。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l2-q9',
        ...
        '三個朋友互相看了很久。'),
      // Q10 listen-comp INFERENCE gist — implication, not surface restate
      gist('kt-ch4-l2-q10',
        'Three animals came one by one, and each one walked away with no help.',
        'What does this scene tell us about the team?',
        ['they will soon need help from someone else',
         'the Camel is a great team leader',
         'the desert will be empty by morning',
         'Man already knows about everything'],
        ['他們很快要找別人幫忙', '駱駝是好的領隊', '沙漠到早上會空了', '人類早就知道一切'],
        0,
        '推理:三人沒得到幫助 → 工作做不完 → 必須去找別人 → 答 need help from someone else。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l3-q5',
        ...
        '人說:「那麼你們三個每天要做雙倍的工作。」'),
      // Q6 listen-mc INFERENCE — implication on their daily life
      mc('kt-ch4-l3-q6',
        'They had to do their own work and the Camel\'s work too.',
        'How would their days now feel?',
        ['shorter than usual', 'much longer and harder', 'lighter and easier', 'full of free time'],
        ['比平常更短', '更長更累', '更輕鬆', '充滿空閒時間'],
        1,
        '推理:自己的工作 + 駱駝的工作 → 時間不夠 → 答 longer and harder。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l4-q7',
        ...
        '精靈搓著下巴,想了很久。'),
      // Q8 listen-mc INFERENCE — purpose behind the search
      mc('kt-ch4-l4-q8',
        'He wanted to find out where this lazy friend was hiding.',
        'Why did the Djinn want to find that place?',
        ['bringing him a meal', 'speaking with him face to face', 'walking him home for tea', 'singing him a new song'],
        ['送他一頓飯', '當面跟他談', '帶他回家喝茶', '教他唱新歌'],
        1,
        '推理:聽完三人不平 + 想找懶夥伴 → 要去當面處理 → 答 talk face to face。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l5-q5',
        ...
        '精靈說:「我的朋友,我聽到一個難過的報告。」'),
      // Q6 listen-mc INFERENCE — who carries the cost
      mc('kt-ch4-l5-q6',
        'He spoke about a friend who would not lift his share.',
        'Who ended up paying for that choice?',
        ['Man alone', 'the other animals', 'the Djinn himself', 'no one at all'],
        ['只有人類', '其他動物', '精靈自己', '完全沒人'],
        1,
        '推理:他不抬自己的份 → 別人要替他扛 → 答 the other animals。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      // Q6 listen-mc INFERENCE — meaning of the change, not surface paraphrase
      mc('kt-ch4-l6-q6',
        'And as he said that word, his flat back began to push up.',
        'What does this tell us about his rude word?',
        ['no power at all', 'a force changing his body', 'something making the sun hotter', 'a call to other animals'],
        ['完全沒影響', '一股改變他身體的力量', '讓太陽更熱的東西', '對其他動物的呼叫'],
        1,
        '推理:一說 humph 背就變 → 那個字觸發了身體變化 → 答 changing his body。'),
      ...
      // Q10 listen-comp INFERENCE — what the change means for him going forward
      inferLc('kt-ch4-l6-q10',
        'The soft shape stayed on him, and it did not go down again.',
        'What might this new shape mean for his future?',
        ['he can keep saying humph and stay free',
         'he will carry something every single day',
         'the other animals will give him gifts',
         'Man will let him sleep all year'],
        ['他能繼續說 humph 保持自由', '他每天都要帶著一個東西', '其他動物會送他禮物', '人類會讓他睡一整年'],
        1,
        '推理:形狀留在身上不消失 → 他從此天天帶著它 → 答 carry something every day。'),
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      nar('kt-ch4-l7-q5',
        ...
        '精靈說:「現在你可以三天不吃東西也能工作。」'),
      // Q6 listen-mc INFERENCE — long-trip implication, no grammar mirror
      mc('kt-ch4-l7-q6',
        'The big shape stored what he needed to live on the road.',
        'Why was that helpful for the Camel?',
        ['winning every race', 'traveling long without stopping', 'resting under shady trees', 'speaking with the wind'],
        ['每場賽跑都贏', '走很遠不用停', '在樹蔭下休息', '跟風說話'],
        1,
        '推理:身上有存糧 → 路上不必常停下 → 答 travel long without stopping。'),
