...
- **Total Q**: 977
- **Total play time est**: 556 min
- **Avg Q per chapter**: 140
- **25% tolerance band**: 105 ≤ Q ≤ 175
...
|----|-------|---------|---------|--------------|--------------------------------|-------------------|-----------|
| 1 | 桃太郎 | 7 | 77 | 11.0 | 239s/lesson ✓ | -45% | ⚠️ OUT |
| 2 | 醜小鴨 | 25 | 150 | 6.0 | 212s/lesson ✓ | +7% | ✓ |
| 3 | 龜兔賽跑 | 25 | 150 | 6.0 | 210s/lesson ✓ | +7% | ✓ |
| 4 | 駱駝為什麼有駝峰 | 25 | 150 | 6.0 | 211s/lesson ✓ | +7% | ✓ |
| 5 | Baba Yaga | 25 | 150 | 6.0 | 211s/lesson ✓ | +7% | ✓ |
| 6 | 六隻天鵝 | 25 | 150 | 6.0 | 214s/lesson ✓ | +7% | ✓ |
| 7 | 葉限 | 25 | 150 | 6.0 | 209s/lesson ✓ | +7% | ✓ |
...
| `kt-ch1-l2` | 桃子裡有什麼聲音? | B4+B3 | 桃子裡是什麼?是嬰兒?活的? | [momotaro.md#beat-2-discovery](../docs/canon/momotaro.md#beat-2-discovery) |
| `kt-ch1-l3` | 鬼來之前我要去 | B5+B2 | 父母會讓他走嗎? | [momotaro.md#beat-3-birth](../docs/canon/momotaro.md#beat-3-birth) |
| `kt-ch1-l4` | 路上遇狗 — 狗會跟嗎? | B4 | 狗會跟?還會遇誰? | [momotaro.md#beat-4-mission](../docs/canon/momotaro.md#beat-4-mission) |
...
| `kt-ch2-l11` | 獨自走過沼澤 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l12` | 獵人的槍聲 — 我躲在草叢裡 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l13` | 老農婦短暫收留 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l14` | 看到白色大鳥飛過 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l15` | 冬天最冷的日子 — 凍在冰湖邊 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l16` | 農夫把我撿回家救活 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l17` | 春天倒影揭曉 — 原來我是天鵝 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l18` | 一群天鵝把我當同伴 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l19` | 老鼠驚動獅子 + 獅子放牠走 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l20` | 獅子被網困住 — 老鼠咬斷網救牠 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l21` | 牧羊男孩三次喊「狼來了」 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch2-l22` | 真狼來了 — 沒人相信他 | _(no hook yet)_ | _-_ | _-_ |
...
| `kt-ch3-l11` | Hare 在矮樹叢下睡著 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l12` | Tortoise 走過河邊 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l13` | Tortoise 經過睡熟的 Hare | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l14` | 腳痛了,他繼續走 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l15` | 老樹出現在前方 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l16` | Tortoise 的鼻子碰到樹幹 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l17` | Hare 驚醒,衝刺已太晚 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l18` | 「為什麼?」「我沒停下來。」 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l19` | 烏鴉嘴上叼著一塊起司 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l20` | 狐狸奉承,烏鴉開口,起司掉了 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l21` | 城市鼠拜訪鄉村鼠 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch3-l22` | 鄉村鼠聽到貓聲,選擇回鄉 | _(no hook yet)_ | _-_ | _-_ |
...
| `kt-ch4-l11` | "Humph!" the third time (拒絕三) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l12` | The Three complain to Man (三隻動物去告狀) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l13` | Man calls the Djinn of All Deserts (人召喚精靈) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l14` | The Djinn rolls in dust and finds the Camel (精靈出場) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l15` | The Djinn warns: "My long and bubbling friend" (警告) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l16` | The Camel just says "Humph!" (頑固) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l17` | Magic: a humph grows on his back (駝峰長出來) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l18` | The Camel must work three days without eating (懲罰 + 補課) | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l19` | 蘆葦與橡樹 ①:橡樹笑蘆葦軟弱 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l20` | 蘆葦與橡樹 ②:大風吹倒橡樹,蘆葦彎腰存活 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l21` | 老鼠開會 ①:老鼠們提議在貓脖子上掛鈴 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch4-l22` | 老鼠開會 ②:沒有老鼠敢去掛 | _(no hook yet)_ | _-_ | _-_ |
...
| `kt-ch5-l11` | 第一次見 Baba Yaga | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l12` | 第一個任務 — 掃院子 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l13` | 第二個任務 — 分穀子 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l14` | 餵娃娃吃麵包 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l15` | 娃娃半夜偷偷幫忙 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l16` | 第三天早上任務都完成 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l17` | Baba Yaga 給火 — 發亮骷髏 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l18` | Vasilisa 回家路上骷髏照亮森林 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l19` | 漁夫釣到會說話的魚 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l20` | 妻子越要越多最後失去一切 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l21` | 小孩走進空屋試七張床 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch5-l22` | 主人回家小孩跑掉 | _(no hook yet)_ | _-_ | _-_ |
...
| `kt-ch6-l11` | 天鵝回家,變回男孩一刻鐘 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l12` | 解咒條件:六年沉默 + 縫六件星花襯衫 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l13` | 她開始採星花,刺破手指也不哭 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l14` | 她坐在樹上織衣,年輕國王發現她 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l15` | 國王帶她回宮,愛她沉默的臉 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l16` | 王后的母親說謊,要燒死她 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l17` | 火堆點起,她抱著六件襯衫 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l18` | 六隻天鵝穿過煙降下,她扔出襯衫 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l19` | 三個願望:伐木工人 vs 妻子,起爭執 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l20` | 三個願望:香腸掉鼻上,最後一個願望浪費 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l21` | 老鼠新娘:父母想替女兒找最強的對象 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch6-l22` | 老鼠新娘:太陽 → 雲 → 風 → 牆 → 老鼠 | _(no hook yet)_ | _-_ | _-_ |
...
| `kt-ch7-l11` | 葉限在空池邊哭 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l12` | 白髮老人現身, 教她埋骨 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l13` | 葉限把魚骨藏在洞穴 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l14` | 洞節將至, 魚骨給金衣 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l15` | 葉限戴金履赴宴跳舞 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l16` | 國王見她, 葉限奔逃落履 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l17` | 國王搜村, 一履配一足 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l18` | 國王迎娶葉限, 後母伏石 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l19` | 田螺姑娘: 漁夫拾螺帶回家 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l20` | 田螺姑娘: 螺中走出煮飯姑娘 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l21` | 嫦娥奔月: 后羿求得仙藥 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l22` | 嫦娥奔月: 嫦娥飛上月宮 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l23` | 奶奶合書, 這是最後一夜 | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l24` | Hana 問: 葉限她怕嗎? | _(no hook yet)_ | _-_ | _-_ |
| `kt-ch7-l25` | 畢業: 八個夜晚, 八個故事, Mochi 記得 | _(no hook yet)_ | _-_ | _-_ |

## Q type distribution per chapter

| Ch | emoji-pick | listen-comprehension | listen-emoji | listen-mc | listen-tf | narration | read-mc-with-audio | tap-pairs | tap-tiles |
|----|---|---|---|---|---|---|---|---|---|
| 1 | 7 | 1 | 0 | 14 | 7 | 41 | 0 | 7 | 0 |
| 2 | 0 | 31 | 25 | 83 | 0 | 0 | 0 | 3 | 8 |
| 3 | 0 | 28 | 25 | 75 | 0 | 0 | 0 | 5 | 17 |
| 4 | 0 | 27 | 24 | 84 | 0 | 0 | 0 | 3 | 12 |
| 5 | 0 | 27 | 23 | 76 | 0 | 0 | 0 | 3 | 21 |
| 6 | 0 | 35 | 22 | 65 | 0 | 0 | 10 | 5 | 13 |
| 7 | 0 | 25 | 27 | 87 | 0 | 0 | 0 | 1 | 10 |
